...
* load sample gene lists:
  * choose Cluster #1: select GSE6887 NKcell Healthy top200UpRegulated.txt
  * choose Cluster #2: GSE6887 NKcell Healthy top200DownRegulated.txt
* select the Ontologies:
  * GO BiologicalProcess 10.10.2008 (All Evidence codes),
  * KEGG Pathways 14.10.2008 and
  * BioCarta pathway reactome 20.10.2008
...
* select WizMapper (Cytoscape Control Panel)
